...
<title>404 - Sistem Pendukung Keputusan Siswa Berprestasi SMA YADIKA 3</title>
            ...
            <div class="col-md-8 col-lg-4  m-auto">
                <div class="card shadow-lg p-t-20 p-b-20">
                    <div class="card-body text-center">
                        ...
                        <p class="opacity-75">
                            Silakan kembali kehalaman utama, apabila terdapat kesalahan sistem dapat menghubungi admin
                        </p>
                        <div class="p-t-10">
                            <a href="<?=BASE_URL?>" class="btn btn-lg btn-primary">Kembali</a>
